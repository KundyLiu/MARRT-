...
class RrtStar:
    ...
    def planning(self):
        ...
        _,nodes_in_solution=self.extract_path(self.vertex[index])
        ...
        print('unused nodes: {}'.format(unused_nodes))
    ...
    def extract_path(self, node_end):
        ...
        while node.parent is not None:
            ...
            a ,_ = self.get_distance_and_angle(node, node1)
            distance+= a
...
def main():
    ...
    node_start = Node(x_start)
    node_goal = Node(x_goal)
    rrt_star = RrtStar(x_start=x_start, x_goal=x_goal, step_len=0.4, goal_sample_rate=0.10, search_radius=1, iter_max=6659)
    rrt_star.planning()
